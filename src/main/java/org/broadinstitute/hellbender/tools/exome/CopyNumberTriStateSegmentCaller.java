...
public abstract class CopyNumberTriStateSegmentCaller extends CommandLineProgram {
     ...
     * @throws IllegalStateException if the tool is no ready for calling (e.g. the output file was not properly opened).
     * @throws UserException if anything when wrong due to something under the users' control.
     * @throws GATKException if anything when wrong due to something outside the users' control.
     */
