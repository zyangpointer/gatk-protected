...
public class AlleleFractionLikelihoodsUnitTest {
        ...
        for (final double f : Arrays.asList(1e-6, 1e-7, 1e-8)) {
            for (final double mean : Arrays.asList(0.9, 1.0, 1.1)) {
                for (final double variance : Arrays.asList(0.01, 0.005, 0.001)) {
                    ...
                    final AllelicBiasParameters parameters = new AllelicBiasParameters(mean, variance, pi);
    ...
    public void testHetLogLikelihoodOutlierProbabilityDependence() {
        ...
        final AllelicBiasParameters parameters1 = new AllelicBiasParameters(mean, variance, pi1);
        final AllelicBiasParameters parameters2 = new AllelicBiasParameters(mean, variance, pi2);
        final AllelicBiasParameters parameters3 = new AllelicBiasParameters(mean, variance, pi3);
