...
public class AlleleFractionHiddenMarkovModelUnitTest {
    ...
    public void constructorTest() {
        ...
        final AllelicBiasParameters params = new AllelicBiasParameters(0.1, 0.01, 0.03);
        AlleleFractionHiddenMarkovModel model = new AlleleFractionHiddenMarkovModel(minorAlleleFractions, weights,
