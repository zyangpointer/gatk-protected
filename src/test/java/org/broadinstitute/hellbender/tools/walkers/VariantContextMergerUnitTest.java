...
public class VariantContextMergerUnitTest extends BaseTest {
    private Allele Aref, T, C, G, Cref, ATC, ATCATC;
    private Allele ATCATCT;
    private Allele ATref;
    private Allele Anoref;
    private Allele GT;
    private Allele del;
    ...
    public void setup() throws IOException {
        ...
        del = GATKVCFConstants.SPANNING_DELETION_SYMBOLIC_ALLELE_DEPRECATED;
